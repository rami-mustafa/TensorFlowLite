...
extension CameraViewController {
    func rgbDataFromBuffer(
        ...
        let destinationBytesPerRow = inputWidth * 3 // RGB
        ...
        guard let destinationData = malloc(inputHeight * destinationBytesPerRow) else {
        ...
        let byteData = Data(bytes: destinationBuffer.data, count: destinationBytesPerRow * inputHeight)
        return byteData
    }
}
